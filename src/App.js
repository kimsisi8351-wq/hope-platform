...
export default function App() {
  ...
  const filtered = profiles
    .filter((p) => {
      ...
      if (selectedCountry === "all") return matchName;
      return matchName && p.country === selectedCountry;
    })
  ...
  const Header = () => (
    <div style={styles.header}>
      ...
      <div style={styles.menu}>
        <button style={styles.menuBtn} onClick={() => setPage("main")}>홈</button>
        <button style={styles.menuBtn} onClick={() => setPage("ranking")}>랭킹</button>
        <button style={styles.menuBtn} onClick={() => setPage("notice")}>공지사항</button>
        ...
        <button style={styles.menuBtn}>운영정책</button>
        <button style={styles.menuBtn}>고객센터</button>
      </div>
    </div>
  );
